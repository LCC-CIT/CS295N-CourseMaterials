...
| Weekly Topics                                 |                               |
| --------------------------------------------- | ----------------------------- |
| <mark>1. Intro to Web Dev</mark>              | 6. Input Validation           |
| 2. Intro to MVC / Deploying to Azure          | 7. Debugging                  |
...
This week you will get an overview of web development and of ASP.NET (Core) MVC.
...
4. Set up a GitHub repostiory
5. Send a PR and do a code review on a PR.
6. Set up an account on the Azure cloud.

## Due Dates for this Week's Learning Activities

- Reading quiz: Wednesday, 1/7
- Lab 1 beta version, PR to lab partner: Sunday, 1/11
- Lab 1 code review: Tuesday, 1/13
- Lab 1 production version: Thursday, 1/15
